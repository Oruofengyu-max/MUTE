"""
The python implementation of mutate that works on compiled Solidity \
Smart Contracts.
...
def SolMOSA(config):
    ...
    Arguments:
        ...
        all the parameters necessary for the mutate algorithm.
    Outputs:
        ...
        the algorithm.
        - tSuite: The TestSuite object that was used by the mutate algorithm.
...
def get_ETH_properties(ETH_port, max_accounts, accounts_file_location,
    ...
    with open(contract_json_location, "r", encoding="utf-8") as f:
