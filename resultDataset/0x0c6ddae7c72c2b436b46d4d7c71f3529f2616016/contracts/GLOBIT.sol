...
contract GLOBIT is ERC20Interface, Owned {
    ...
    function setTotalLockedTime(uint _value) public onlyOwner {
    ...
    function transfer(address to, uint tokens) public onlyWhenUnlocked validDestination(to) returns (bool success) {
